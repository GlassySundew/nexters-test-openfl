...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("NextersTestOpenfl1", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("NextersTestOpenfl1", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "NextersTestOpenfl1";
		app.meta["name"] = "NextersTestOpenfl1";
		app.meta["packageName"] = "com.sample.nexterstestopenfl1";
